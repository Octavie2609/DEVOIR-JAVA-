...
public class DaoPersonne implements IDao<Personne>{
    private final String SQL_SELECT_BY_CLASSE="select p.id,nom_complet,tuteur ,classe_id,libelle,nbre from personne p,classe cl where type='Etudiant' and classe_id=? and cl.id=p.classe_id";
